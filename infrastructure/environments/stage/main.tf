...
module "api-gateway-stage" {
  source           = "../../../api/api-gateway/infrastructure"
...
module "api-analytics" {
  source                = "../../../api/api-analytics/infrastructure"
...
module "api-journeys" {
  source        = "../../../api/api-journeys/infrastructure"
  ecs_config    = local.internal_ecs_config
  env           = "stage"
...
module "api-journeys-modern" {
  source        = "../../../api/api-journeys-modern/infrastructure"
  ecs_config    = local.internal_ecs_config
  env           = "stage"
  doppler_token = data.aws_ssm_parameter.doppler_api_journeys_stage_token.value
  alb = {
...
module "api-languages" {
  source        = "../../../api/api-languages/infrastructure"
  ecs_config    = local.internal_ecs_config
  env           = "stage"
...
module "api-users" {
  source        = "../../../api/api-users/infrastructure"
  ecs_config    = local.internal_ecs_config
  env           = "stage"
...
module "api-media" {
  source        = "../../../api/api-media/infrastructure"
  ecs_config    = local.internal_ecs_config
  env           = "stage"
