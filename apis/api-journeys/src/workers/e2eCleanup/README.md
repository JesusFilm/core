...
nx run api-journeys:playwright-cleanup e2e-cleanup

# Dry run to see what would be deleted
nx run api-journeys:playwright-cleanup e2e-cleanup --dry-run

# Cleanup data older than 48 hours
nx run api-journeys:playwright-cleanup e2e-cleanup --hours 48

# Dry run for data older than 12 hours
nx run api-journeys:playwright-cleanup e2e-cleanup --dry-run --hours 12
```
