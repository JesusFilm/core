...
export default interface PrismaTypes {
    ...
    MuxVideo: {
        ...
        Create: {};
        Update: {};
        RelationName: "videoVariants" | "variantUploads" | "subtitles";
        ListRelations: "videoVariants" | "variantUploads" | "subtitles";
        Relations: {
            videoVariants: {
                Shape: VideoVariant[];
                Name: "VideoVariant";
            ...
            variantUploads: {
                Shape: VideoVariantUpload[];
                Name: "VideoVariantUpload";
                Nullable: false;
            };
            subtitles: {
    ...
    CloudflareR2: {
        ...
        Create: {};
        Update: {};
        RelationName: "video" | "videoVariant" | "videoVariantUploads" | "videoVariantDownloads" | "videoSubtitleSrt" | "videoSubtitleVtt";
        ListRelations: "videoVariantUploads" | "videoVariantDownloads";
        Relations: {
            video: {
                Shape: Video | null;
                Name: "Video";
    ...
    Video: {
        ...
        Create: {};
        Update: {};
        RelationName: "title" | "snippet" | "description" | "studyQuestions" | "imageAlt" | "subtitles" | "children" | "parents" | "variants" | "variantUploads" | "variantReconciliations" | "bibleCitation" | "keywords" | "images" | "cloudflareAssets" | "videoEditions" | "origin" | "userMediaProfiles";
        ListRelations: "title" | "snippet" | "description" | "studyQuestions" | "imageAlt" | "subtitles" | "children" | "parents" | "variants" | "variantUploads" | "variantReconciliations" | "bibleCitation" | "keywords" | "images" | "cloudflareAssets" | "videoEditions" | "userMediaProfiles";
        Relations: {
            title: {
                Shape: VideoTitle[];
                Name: "VideoTitle";
            ...
            variantReconciliations: {
                Shape: VideoVariantReconciliation[];
                Name: "VideoVariantReconciliation";
                Nullable: false;
            };
            bibleCitation: {
                Shape: BibleCitation[];
    ...
    VideoVariant: {
        ...
        Create: {};
        Update: {};
        RelationName: "downloads" | "videoEdition" | "video" | "asset" | "muxVideo" | "variantUploads" | "reconciliation" | "playlistItems" | "youtubeVideos";
        ListRelations: "downloads" | "variantUploads" | "playlistItems" | "youtubeVideos";
        Relations: {
            downloads: {
                Shape: VideoVariantDownload[];
                Name: "VideoVariantDownload";
            ...
            reconciliation: {
                Shape: VideoVariantReconciliation | null;
                Name: "VideoVariantReconciliation";
                Nullable: true;
            };
            playlistItems: {
    ...
    VideoVariantUpload: {
        Name: "VideoVariantUpload";
        Shape: VideoVariantUpload;
        Include: Prisma.VideoVariantUploadInclude;
        Select: Prisma.VideoVariantUploadSelect;
        OrderBy: Prisma.VideoVariantUploadOrderByWithRelationInput;
        WhereUnique: Prisma.VideoVariantUploadWhereUniqueInput;
        Where: Prisma.VideoVariantUploadWhereInput;
        Create: {};
        Update: {};
        RelationName: "video" | "r2Asset" | "muxVideo" | "videoVariant";
        ListRelations: never;
        Relations: {
            video: {
                Shape: Video;
    ...
    VideoVariantReconciliation: {
        Name: "VideoVariantReconciliation";
        Shape: VideoVariantReconciliation;
        Include: Prisma.VideoVariantReconciliationInclude;
        Select: Prisma.VideoVariantReconciliationSelect;
        OrderBy: Prisma.VideoVariantReconciliationOrderByWithRelationInput;
        WhereUnique: Prisma.VideoVariantReconciliationWhereUniqueInput;
        Where: Prisma.VideoVariantReconciliationWhereInput;
        Create: {};
        Update: {};
        RelationName: "video" | "videoVariant";
        ListRelations: never;
        Relations: {
            video: {
                Shape: Video;
    ...
    YoutubeVideo: {
        Name: "YoutubeVideo";
        Shape: YoutubeVideo;
        Include: Prisma.YoutubeVideoInclude;
        Select: Prisma.YoutubeVideoSelect;
        OrderBy: Prisma.YoutubeVideoOrderByWithRelationInput;
        WhereUnique: Prisma.YoutubeVideoWhereUniqueInput;
