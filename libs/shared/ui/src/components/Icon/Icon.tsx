...
export function Icon({ name, color, size }: IconProps): ReactElement | null {
  ...
  switch (name) {
    ...
    case 'PlayArrow':
      return <PlayArrow color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'Translate':
      return <Translate color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'RadioButtonUnchecked':
      return <RadioButtonUnchecked color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'FormatQuote':
      return <FormatQuote color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'LockOpen':
      return <LockOpen color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'ArrowForward':
      return <ArrowForward color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'ChatBubbleOutline':
      return <ChatBubbleOutline color={color ?? undefined} sx={{ fontSize: fontSize }} />
    case 'LiveTv':
