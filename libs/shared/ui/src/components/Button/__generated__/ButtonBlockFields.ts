...
export type ButtonBlockFields_action = ButtonBlockFields_action_NavigateAction | ButtonBlockFields_action_NavigateToJourneyAction | ButtonBlockFields_action_LinkAction;
