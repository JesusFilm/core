...
export declare enum VideoBlockSource {
    internal = "internal",
    youTube = "youTube",
    cloudflare = "cloudflare",
    mux = "mux"
}
export declare enum VideoBlockObjectFit {
    fill = "fill",
    fit = "fit",
    zoomed = "zoomed"
}
...
export declare enum JourneyMenuButtonIcon {
    menu1 = "menu1",
    equals = "equals",
    home3 = "home3",
    home4 = "home4",
...
export declare enum JourneysReportType {
    multipleFull = "multipleFull",
    multipleSummary = "multipleSummary",
    singleFull = "singleFull",
    singleSummary = "singleSummary"
}
export declare enum JourneyVisitorSort {
    date = "date",
    duration = "duration",
    activity = "activity"
}
export declare enum UserJourneyRole {
...
export declare class NavigateToBlockActionInput {
    gtmEventName?: Nullable<string>;
    blockId: string;
}
export declare class LinkActionInput {
    gtmEventName?: Nullable<string>;
    url: string;
...
export declare class EmailActionInput {
    gtmEventName?: Nullable<string>;
    email: string;
    customizable?: Nullable<boolean>;
    parentStepId?: Nullable<string>;
}
export declare class BlockUpdateActionInput {
    gtmEventName?: Nullable<string>;
...
export declare class BlocksFilter {
    journeyIds?: Nullable<string[]>;
    typenames?: Nullable<string[]>;
}
export declare class BlockDuplicateIdMap {
    oldId: string;
    newId: string;
}
export declare class ButtonBlockSettingsInput {
    alignment?: Nullable<ButtonAlignment>;
    color?: Nullable<string>;
}
export declare class ButtonBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
...
export declare class ButtonBlockUpdateInput {
...
export declare class CardBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
...
export declare class CardBlockUpdateInput {
    parentBlockId?: Nullable<string>;
...
export declare class IconBlockCreateInput {
    id?: Nullable<string>;
    parentBlockId: string;
    journeyId: string;
...
export declare class IconBlockUpdateInput {
    name?: Nullable<IconName>;
    color?: Nullable<IconColor>;
    size?: Nullable<IconSize>;
}
export declare class ImageBlockCreateInput {
    id?: Nullable<string>;
    parentBlockId?: Nullable<string>;
    journeyId: string;
    src?: Nullable<string>;
...
export declare class ImageBlockUpdateInput {
    parentBlockId?: Nullable<string>;
    src?: Nullable<string>;
    alt?: Nullable<string>;
    blurhash?: Nullable<string>;
...
export declare class RadioOptionBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
    label: string;
}
export declare class RadioOptionBlockUpdateInput {
    parentBlockId?: Nullable<string>;
    label?: Nullable<string>;
    pollOptionImageBlockId?: Nullable<string>;
}
export declare class RadioQuestionBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
}
export declare class SignUpBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
    submitLabel: string;
}
export declare class SignUpBlockUpdateInput {
    parentBlockId?: Nullable<string>;
    submitIconId?: Nullable<string>;
    submitLabel?: Nullable<string>;
}
export declare class SpacerBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
    spacing?: Nullable<number>;
}
export declare class SpacerBlockUpdateInput {
    parentBlockId?: Nullable<string>;
    spacing?: Nullable<number>;
}
export declare class StepBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
...
export declare class StepBlockUpdateInput {
    nextBlockId?: Nullable<string>;
    locked?: Nullable<boolean>;
    x?: Nullable<number>;
    y?: Nullable<number>;
...
export declare class StepBlockPositionUpdateInput {
    id: string;
    x?: Nullable<number>;
    y?: Nullable<number>;
}
export declare class TextResponseBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
    label: string;
}
export declare class TextResponseBlockUpdateInput {
    parentBlockId?: Nullable<string>;
    label?: Nullable<string>;
...
export declare class TypographyBlockSettingsInput {
    color?: Nullable<string>;
}
export declare class TypographyBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
    content: string;
...
export declare class TypographyBlockUpdateInput {
    parentBlockId?: Nullable<string>;
...
export declare class VideoBlockCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    parentBlockId: string;
...
export declare class VideoBlockUpdateInput {
    startAt?: Nullable<number>;
    endAt?: Nullable<number>;
    muted?: Nullable<boolean>;
    autoplay?: Nullable<boolean>;
...
export declare class ChatButtonCreateInput {
    link?: Nullable<string>;
    platform?: Nullable<MessagePlatform>;
}
export declare class ChatButtonUpdateInput {
    link?: Nullable<string>;
    platform?: Nullable<MessagePlatform>;
}
export declare class CustomDomainCreateInput {
    id?: Nullable<string>;
    teamId: string;
    name: string;
...
export declare class CustomDomainUpdateInput {
    journeyCollectionId?: Nullable<string>;
    routeAllTeamJourneys?: Nullable<boolean>;
}
export declare class ButtonClickEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
...
export declare class ChatOpenEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    value?: Nullable<MessagePlatform>;
}
export declare class JourneyViewEventCreateInput {
    id?: Nullable<string>;
    journeyId: string;
    label?: Nullable<string>;
    value?: Nullable<string>;
}
export declare class RadioQuestionSubmissionEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
...
export declare class SignUpSubmissionEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    name: string;
...
export declare class StepViewEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    value?: Nullable<string>;
}
export declare class StepNextEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    nextStepId: string;
    label?: Nullable<string>;
...
export declare class StepPreviousEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
...
export declare class TextResponseSubmissionEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    label?: Nullable<string>;
...
export declare class VideoStartEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
...
export declare class VideoPlayEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class VideoPauseEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class VideoCompleteEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class VideoExpandEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class VideoCollapseEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class VideoProgressEventCreateInput {
    id?: Nullable<string>;
    blockId: string;
    stepId?: Nullable<string>;
    position?: Nullable<number>;
...
export declare class HostUpdateInput {
    title?: Nullable<string>;
    location?: Nullable<string>;
    src1?: Nullable<string>;
    src2?: Nullable<string>;
}
export declare class HostCreateInput {
    title: string;
    location?: Nullable<string>;
    src1?: Nullable<string>;
    src2?: Nullable<string>;
}
export declare class IntegrationGrowthSpacesCreateInput {
    accessId: string;
    accessSecret: string;
    teamId: string;
}
export declare class IntegrationGrowthSpacesUpdateInput {
    accessId: string;
    accessSecret: string;
}
export declare class JourneysFilter {
...
export declare class JourneysQueryOptions {
    hostname?: Nullable<string>;
    embedded?: Nullable<boolean>;
    journeyCollection?: Nullable<boolean>;
}
export declare class JourneyCreateInput {
    id?: Nullable<string>;
    title: string;
    languageId: string;
    themeMode?: Nullable<ThemeMode>;
...
export declare class JourneyUpdateInput {
    title?: Nullable<string>;
...
export declare class JourneyTemplateInput {
    template?: Nullable<boolean>;
}
export declare class JourneyCollectionCreateInput {
    id?: Nullable<string>;
    teamId: string;
    title?: Nullable<string>;
    journeyIds?: Nullable<string[]>;
}
export declare class JourneyCollectionUpdateInput {
    title?: Nullable<string>;
    journeyIds?: Nullable<string[]>;
}
export declare class JourneyCustomizationFieldInput {
    id: string;
    key: string;
    value?: Nullable<string>;
}
export declare class JourneyEventsFilter {
    typenames?: Nullable<string[]>;
    periodRangeStart?: Nullable<DateTime>;
    periodRangeEnd?: Nullable<DateTime>;
}
export declare class JourneyNotificationUpdateInput {
    journeyId: string;
    visitorInteractionEmail: boolean;
}
export declare class JourneyProfileUpdateInput {
...
export declare class JourneyThemeCreateInput {
    journeyId: string;
    headerFont?: Nullable<string>;
    bodyFont?: Nullable<string>;
    labelFont?: Nullable<string>;
}
export declare class JourneyThemeUpdateInput {
    headerFont?: Nullable<string>;
    bodyFont?: Nullable<string>;
    labelFont?: Nullable<string>;
}
export declare class JourneyVisitorFilter {
    journeyId: string;
...
export declare class JourneysEmailPreferenceUpdateInput {
    email: string;
    preference: string;
    value: boolean;
}
export declare class PlausibleStatsAggregateFilter {
    period?: Nullable<string>;
    date?: Nullable<string>;
    filters?: Nullable<string>;
    interval?: Nullable<string>;
}
export declare class PlausibleStatsBreakdownFilter {
    property: string;
    period?: Nullable<string>;
    date?: Nullable<string>;
    limit?: Nullable<number>;
...
export declare class PlausibleStatsTimeseriesFilter {
    period?: Nullable<string>;
    date?: Nullable<string>;
    filters?: Nullable<string>;
    interval?: Nullable<string>;
}
export declare class QrCodesFilter {
...
export declare class UserInviteCreateInput {
    email: string;
}
export declare class UserTeamUpdateInput {
    role: UserTeamRole;
}
export declare class UserTeamFilterInput {
    role?: Nullable<UserTeamRole[]>;
}
export declare class UserTeamInviteCreateInput {
    email: string;
}
export declare class VisitorUpdateInput {
    email?: Nullable<string>;
...
export declare class NavigateToBlockAction implements Action {
...
export declare class ButtonBlockSettings {
    __typename?: 'ButtonBlockSettings';
    alignment?: Nullable<ButtonAlignment>;
    color?: Nullable<string>;
}
export declare class ButtonBlock implements Block {
...
export declare class CardBlock implements Block {
...
export declare class GridContainerBlock implements Block {
...
export declare class GridItemBlock implements Block {
...
export declare class IconBlock implements Block {
...
export declare class ImageBlock implements Block {
...
export declare class RadioOptionBlock implements Block {
...
export declare class RadioQuestionBlock implements Block {
...
export declare class SignUpBlock implements Block {
...
export declare class SpacerBlock implements Block {
...
export declare class StepBlock implements Block {
...
export declare class TextResponseBlock implements Block {
...
export declare class TypographyBlockSettings {
    __typename?: 'TypographyBlockSettings';
    color?: Nullable<string>;
}
export declare class TypographyBlock implements Block {
...
export declare class VideoBlock implements Block {
...
export declare class VideoTriggerBlock implements Block {
...
export declare class CustomDomainCheck {
...
export declare class CustomDomainVerification {
...
export declare class CustomDomainVerificationResponse {
    __typename?: 'CustomDomainVerificationResponse';
    code: string;
    message: string;
}
export declare class ButtonClickEvent implements Event {
...
export declare class ChatOpenEvent implements Event {
...
export declare class JourneyViewEvent implements Event {
...
export declare class RadioQuestionSubmissionEvent implements Event {
...
export declare class SignUpSubmissionEvent implements Event {
...
export declare class StepViewEvent implements Event {
...
export declare class StepNextEvent implements Event {
...
export declare class StepPreviousEvent implements Event {
...
export declare class TextResponseSubmissionEvent implements Event {
...
export declare class VideoStartEvent implements Event {
...
export declare class VideoPlayEvent implements Event {
...
export declare class VideoPauseEvent implements Event {
...
export declare class VideoCompleteEvent implements Event {
...
export declare class VideoExpandEvent implements Event {
...
export declare class VideoCollapseEvent implements Event {
...
export declare class VideoProgressEvent implements Event {
...
export declare class IntegrationGrowthSpaces implements Integration {
...
export declare class IntegrationGrowthSpacesRoute {
    __typename?: 'IntegrationGrowthSpacesRoute';
    id: string;
    name: string;
}
export declare class PowerBiEmbed {
...
export declare class JourneyCollection {
...
export declare class JourneyCustomizationField {
...
export declare class JourneyEvent implements Event {
...
export declare class JourneyEventEdge {
    __typename?: 'JourneyEventEdge';
    cursor: string;
    node: JourneyEvent;
}
export declare class JourneyEventsConnection {
    __typename?: 'JourneyEventsConnection';
    edges: JourneyEventEdge[];
    pageInfo: PageInfo;
}
export declare class JourneyNotification {
...
export declare class JourneyProfile {
...
export declare class JourneyTheme {
...
export declare class JourneyVisitor {
...
export declare class JourneyVisitorEdge {
    __typename?: 'JourneyVisitorEdge';
    cursor: string;
    node: JourneyVisitor;
}
export declare class JourneyVisitorsConnection {
    __typename?: 'JourneyVisitorsConnection';
    edges: JourneyVisitorEdge[];
    pageInfo: PageInfo;
}
export declare class JourneysEmailPreference {
    __typename?: 'JourneysEmailPreference';
    email: string;
    unsubscribeAll: boolean;
    accountNotifications: boolean;
}
export declare class PlausibleStatsAggregateValue {
    __typename?: 'PlausibleStatsAggregateValue';
    value: number;
    change?: Nullable<number>;
}
export declare class PlausibleStatsAggregateResponse {
...
export declare class PlausibleStatsResponse {
...
export declare class UserTeamInvite {
...
export declare class VisitorEdge {
...
export declare class VisitorsConnection {
