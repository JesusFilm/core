...
describe('CopyToTeamDialog', () => {
  ...
  describe('Create with AI functionality', () => {
    ...
    describe('Button Rendering', () => {
      it('should show Create with AI button when showCreateWithAiButton is true', async () => {
        render(
          <MockedProvider
            mocks={[
              {
      ...
      it('should not show Create with AI button when showCreateWithAiButton is false', async () => {
        render(
          <MockedProvider
            mocks={[
              {
      ...
      it('should not show Create with AI button by default (when showCreateWithAiButton is undefined)', async () => {
        render(
          <MockedProvider
            mocks={[
              {
    ...
    describe('Submission Behavior', () => {
      it('should call submitAction with createWithAi: true when Create with AI button is clicked', async () => {
        const { getByRole } = render(
          <MockedProvider
            mocks={[
              {
        ...
        await waitFor(() => {
          expect(handleSubmitActionMock).toHaveBeenCalledWith(
            ...
            undefined,
            false,
            true // createWithAi should be true
          )
        })
      })

      it('should not call submitAction when Create with AI button is clicked while disabled (translation enabled)', async () => {
        const { getByRole } = render(
          <MockedProvider
            mocks={[
              {
