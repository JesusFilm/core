...
// Create JourneyVisitorSort enum since it doesn't exist in Prisma
...
const VisitorEdge = builder.objectType('VisitorEdge', {
  fields: (t) => ({
    cursor: t.string({
...
const VisitorsConnection = builder.objectType('VisitorsConnection', {
  fields: (t) => ({
    edges: t.field({
      type: [VisitorEdge],
