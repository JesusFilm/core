...
test.describe('Journey level actions', () => {
    ...
    test('Edit existing journey', async ({ page }) => {
        ...
        let journeyName = await journeyPage.getJourneyName()
    ...
    test('Preview existing journey', async ({ page, context }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        let journeyName = await journeyPage.getJourneyName() // getting journay name 
    ...
    test('Verify title option from three dot options on top right in the selected journey page', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        let journeyName = await journeyPage.getJourneyName()
        await journeyPage.clickCreateCustomJourney()// clicking on the create custom journey button
        await journeyPage.createAndVerifyCustomJourney() // creating the custom journey and verifing the created journey is updated in the active tab list
        journeyLevelActions.selectCreatedJourney(journeyName) // clicking on the created journey in the journey list
        await journeyPage.clickThreeDotBtnOfCustomJourney()  // clicking on the three dot at top right corner of the custom journey page 
        await journeyLevelActions.clickThreeDotOptionsOfJourneyCreationPage('Edit Details') // clicking on the Edit Details option of the thre dot options
    ...
    test('Verify description option from three dot options on top right in the selected journey page', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        let journeyName = await journeyPage.getJourneyName() // getting journay name
        await journeyPage.clickCreateCustomJourney() // clicking on the create custom journey button
        ...
        journeyLevelActions.selectCreatedJourney(journeyName) // clicking on the created journey in the journey list 
        await journeyPage.clickThreeDotBtnOfCustomJourney() // clicking on the three dot at top right corner of the custom journey page 
        await journeyLevelActions.clickThreeDotOptionsOfJourneyCreationPage('Edit Details') // clicking on the description option of the three dot options 
    ...
    test('Verify language option from three dot options on top right in the selected journey page', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        await journeyPage.clickCreateCustomJourney()// clicking on the create custom journey button
        await journeyPage.createAndVerifyCustomJourney() // creating the custom journey and verifing the created journey is updated in the active tab list 
        journeyLevelActions.selectExistingJourney() // clicking on existing journey in the journey list
        await journeyPage.clickThreeDotBtnOfCustomJourney()  // clicking on the three dot at top right corner of the custom journey page 
        await journeyLevelActions.clickThreeDotOptionsOfJourneyCreationPage('Edit Details') // clicking on the language option of the three dot options 
    ...
    test('Verify copy link option from three dot options on top right in the selected journey page', async ({ page, context }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        let journeyName = await journeyPage.getJourneyName() // getting the journey name
        await journeyLevelActions.setBrowserContext(context) // setting the context
        await journeyPage.clickCreateCustomJourney()// clicking on the create custom journey button
        await journeyPage.createAndVerifyCustomJourney() // creating the custom journey and verifing the created journey is updated in the active tab list 
        journeyLevelActions.selectCreatedJourney(journeyName) // clicking on the created journey in the journey list 
        await journeyPage.clickThreeDotBtnOfCustomJourney() // clicking on the three dot at top right corner of the custom journey page 
        await journeyLevelActions.clickThreeDotOptionsOfJourneyCreationPage('Copy Link') // clicking on the Copy Link option of the three dot options  
    ...
    test('Verify navigation side menu open and close via navigation list item toggle ', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
    ...
    test('Verify the user able to display the help window through help button', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
    ...
    test('Verify manage access option from three dot options on top right in the selected journey page', async ({ page }) => {
        const journeyLevelActions = new JourneyLevelActions(page)
        const journeyPage = new JourneyPage(page)
        let journeyName = await journeyPage.getJourneyName() // getting journay name
        await journeyPage.clickCreateCustomJourney()// click the create custom journey button
        ...
        await journeyLevelActions.clickThreeDotOptionsOfJourneyCreationPage('Manage Access') // clicking on the manage access option of the thre dot options         await journeyLevelActions.enterTeamMember() // entering mail address of team member in the email field 
