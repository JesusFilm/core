...
test.describe("verify card level actions", () => {
  ...
  test("Text - create, update & delete", async ({ page }) => {
    ...
    await cardLevelActionPage.clickOnCreatedOrRenamedTextInJourneyCard("created"); // clicking on created typography text in the journey card
    ...
    await cardLevelActionPage.clickOnCreatedOrRenamedTextInJourneyCard("renamed"); // clicking on edited typography text in the journey card
