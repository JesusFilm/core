...
2. In a terminal (inside the dev container, or on your host if you followed [Local Setup Without the Dev Container](./05-local-setup-without-dev-container.mdx)), login to the Doppler CLI
