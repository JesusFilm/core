...
You can skip ahead to step 2 in [4. Starting Projects](/docs/getting-started/running-projects/projects-on-local-machine) guide
if getting started without a backend.
