...
In GTM, go to **Variables → User-Defined Variables → New → Variable Configuration → Data Layer Variable**, then enter the `dataLayer` key name (e.g. `fileName`) and save.
...
| ----------------------------- | ------------------------------------ | ------------------------------------ |
| Data Layer Variables          | `dlv - <camelCaseKey>`               | `dlv - fileName`                     |
...
| `dataLayer` keys              | `camelCase`                          | `fileName`, `fileSize`               |
