...
export async function GET(
  ...
  const response = {
    ...
    contentType: 'video',
    imageUrls: {
      thumbnail: video.images.find((image) => image.thumbnail != null)
        ?.thumbnail,
      videoStill: video.images.find((image) => image.videoStill != null)
        ?.videoStill,
      mobileCinematicHigh: video.images.find(
        (image) => image.mobileCinematicHigh != null
      )?.mobileCinematicHigh,
      mobileCinematicLow: video.images.find(
        (image) => image.mobileCinematicLow != null
      )?.mobileCinematicLow,
      mobileCinematicVeryLow: video.images.find(
