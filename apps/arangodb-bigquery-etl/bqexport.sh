...
# event response is very specific due to bq being unable to parse the variable fieldset
...
# blocks response is limited due to having very dynamic fieldsets and json that jq can't easily parse
