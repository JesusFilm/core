...
const selectTriggerStyle = tva({
  base: 'border-background-300 data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[disabled=true]:data-[hover=true]:border-background-300 flex-row items-center overflow-hidden rounded border data-[disabled=true]:opacity-40',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
    ...
    variant: {
      underlined:
        'data-[hover=true]:border-primary-700 data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 rounded-none border-0 border-b',
      outline:
      ...
      rounded:
        'data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 rounded-full'
    }
  }
})

const selectInputStyle = tva({
  base: 'py-auto placeholder:text-typography-500 web:w-full text-typography-900 web:outline-none ios:leading-[0px] pointer-events-none h-full px-3',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
