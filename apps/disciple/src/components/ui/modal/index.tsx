...
const modalContentStyle = tva({
  base: 'bg-background-0 border-outline-100 shadow-hard-2 overflow-hidden rounded-md border p-6',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
...
const modalCloseButtonStyle = tva({
  base: 'group/modal-close-button data-[focus-visible=true]:web:bg-background-100 web:outline-0 z-10 cursor-pointer rounded'
})
