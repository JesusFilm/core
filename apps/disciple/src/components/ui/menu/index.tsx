...
const menuStyle = tva({
  base: 'bg-background-0 border-outline-100 shadow-hard-5 rounded-md border p-1'
})

const menuItemStyle = tva({
  base: 'data-[hover=true]:bg-background-50 data-[active=true]:bg-background-100 data-[focus=true]:bg-background-50 data-[focus=true]:web:outline-none data-[focus=true]:web:outline-0 data-[disabled=true]:web:cursor-not-allowed data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-primary-700 data-[focus-visible=true]:web:outline data-[focus-visible=true]:web:cursor-pointer min-w-[200px] flex-row items-center rounded p-3 data-[disabled=true]:data-[focus=true]:bg-transparent data-[disabled=true]:opacity-40'
})
