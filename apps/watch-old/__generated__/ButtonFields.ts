...
export type ButtonFields_action =
  | ButtonFields_action_NavigateAction
  | ButtonFields_action_NavigateToBlockAction
  | ButtonFields_action_NavigateToJourneyAction
  | ButtonFields_action_LinkAction
  | ButtonFields_action_EmailAction
