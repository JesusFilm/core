...
export type VideoFields_action =
  | VideoFields_action_NavigateAction
  | VideoFields_action_NavigateToBlockAction
  | VideoFields_action_NavigateToJourneyAction
  | VideoFields_action_LinkAction
  | VideoFields_action_EmailAction
