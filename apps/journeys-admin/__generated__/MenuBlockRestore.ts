...
export interface MenuBlockRestore_stepRestore_VideoTriggerBlock {
   ...
   */
  triggerStart: number;
  triggerAction: MenuBlockRestore_stepRestore_VideoTriggerBlock_triggerAction | null;
}
...
export interface MenuBlockRestore_journeyUpdate_menuStepBlock_ImageBlock {
...
export interface MenuBlockRestore_journeyUpdate_menuStepBlock_StepBlock {
  __typename: "StepBlock";
  id: string;
  parentBlockId: string | null;
  parentOrder: number | null;
...
export type MenuBlockRestore_journeyUpdate_menuStepBlock = MenuBlockRestore_journeyUpdate_menuStepBlock_ImageBlock | MenuBlockRestore_journeyUpdate_menuStepBlock_StepBlock;
