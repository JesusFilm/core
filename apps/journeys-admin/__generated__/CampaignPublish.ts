...
export interface CampaignPublish_campaignPublish_team {
  __typename: "Team";
  id: string;
}

export interface CampaignPublish_campaignPublish_media {
...
export interface CampaignPublish_campaignPublish_shareJourneys_language_name {
  __typename: "LanguageName";
  value: string;
  primary: boolean;
}

export interface CampaignPublish_campaignPublish_shareJourneys_language {
  __typename: "Language";
  id: string;
  bcp47: string | null;
  name: CampaignPublish_campaignPublish_shareJourneys_language_name[];
}

export interface CampaignPublish_campaignPublish_shareJourneys_primaryImageBlock {
...
export interface CampaignPublish_campaignPublish_shareJourneys {
  ...
  language: CampaignPublish_campaignPublish_shareJourneys_language;
  primaryImageBlock: CampaignPublish_campaignPublish_shareJourneys_primaryImageBlock | null;
}

export interface CampaignPublish_campaignPublish_templateJourneys_language_name {
  __typename: "LanguageName";
  value: string;
  primary: boolean;
}

export interface CampaignPublish_campaignPublish_templateJourneys_language {
  __typename: "Language";
  id: string;
  bcp47: string | null;
  name: CampaignPublish_campaignPublish_templateJourneys_language_name[];
}

export interface CampaignPublish_campaignPublish_templateJourneys_primaryImageBlock {
  __typename: "ImageBlock";
  id: string;
  src: string | null;
  alt: string;
...
export interface CampaignPublish_campaignPublish_templateJourneys {
  __typename: "CampaignJourneyItem";
  id: string;
  title: string;
  description: string | null;
  ...
  createdAt: any;
  customizable: boolean | null;
  language: CampaignPublish_campaignPublish_templateJourneys_language;
  primaryImageBlock: CampaignPublish_campaignPublish_templateJourneys_primaryImageBlock | null;
}
...
export interface CampaignPublish_campaignPublish {
   ...
   */
  shareJourneys: CampaignPublish_campaignPublish_shareJourneys[];
  /**
   ...
   */
  templateJourneys: CampaignPublish_campaignPublish_templateJourneys[];
}
