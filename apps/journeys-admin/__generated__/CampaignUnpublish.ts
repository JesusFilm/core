...
export interface CampaignUnpublish_campaignUnpublish_team {
  __typename: "Team";
  id: string;
}

export interface CampaignUnpublish_campaignUnpublish_media {
...
export interface CampaignUnpublish_campaignUnpublish_shareJourneys_language_name {
  __typename: "LanguageName";
  value: string;
  primary: boolean;
}

export interface CampaignUnpublish_campaignUnpublish_shareJourneys_language {
  __typename: "Language";
  id: string;
  bcp47: string | null;
  name: CampaignUnpublish_campaignUnpublish_shareJourneys_language_name[];
}

export interface CampaignUnpublish_campaignUnpublish_shareJourneys_primaryImageBlock {
...
export interface CampaignUnpublish_campaignUnpublish_shareJourneys {
  ...
  language: CampaignUnpublish_campaignUnpublish_shareJourneys_language;
  primaryImageBlock: CampaignUnpublish_campaignUnpublish_shareJourneys_primaryImageBlock | null;
}

export interface CampaignUnpublish_campaignUnpublish_templateJourneys_language_name {
  __typename: "LanguageName";
  value: string;
  primary: boolean;
}

export interface CampaignUnpublish_campaignUnpublish_templateJourneys_language {
  __typename: "Language";
  id: string;
  bcp47: string | null;
  name: CampaignUnpublish_campaignUnpublish_templateJourneys_language_name[];
}

export interface CampaignUnpublish_campaignUnpublish_templateJourneys_primaryImageBlock {
  __typename: "ImageBlock";
  id: string;
  src: string | null;
  alt: string;
...
export interface CampaignUnpublish_campaignUnpublish_templateJourneys {
  __typename: "CampaignJourneyItem";
  id: string;
  title: string;
  description: string | null;
  ...
  createdAt: any;
  customizable: boolean | null;
  language: CampaignUnpublish_campaignUnpublish_templateJourneys_language;
  primaryImageBlock: CampaignUnpublish_campaignUnpublish_templateJourneys_primaryImageBlock | null;
}
...
export interface CampaignUnpublish_campaignUnpublish {
   ...
   */
  shareJourneys: CampaignUnpublish_campaignUnpublish_shareJourneys[];
  /**
   ...
   */
  templateJourneys: CampaignUnpublish_campaignUnpublish_templateJourneys[];
}
