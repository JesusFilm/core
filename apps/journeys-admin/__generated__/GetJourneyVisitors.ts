...
export interface GetJourneyVisitors_visitors_edges_node_events_ButtonClickEvent {
  __typename: "ButtonClickEvent" | "ChatOpenEvent" | "JourneyViewEvent" | "RadioQuestionSubmissionEvent" | "SignUpSubmissionEvent" | "StepNextEvent" | "StepPreviousEvent" | "StepViewEvent" | "VideoCollapseEvent" | "VideoCompleteEvent" | "VideoExpandEvent" | "VideoPauseEvent" | "VideoPlayEvent" | "VideoProgressEvent" | "VideoStartEvent";
  id: string;
  createdAt: any;
  label: string | null;
  value: string | null;
