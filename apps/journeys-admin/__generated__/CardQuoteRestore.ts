...
export interface CardQuoteRestore_image_VideoTriggerBlock {
   ...
   */
  triggerStart: number;
  triggerAction: CardQuoteRestore_image_VideoTriggerBlock_triggerAction | null;
}
...
export interface CardQuoteRestore_subtitle_VideoTriggerBlock {
   ...
   */
  triggerStart: number;
  triggerAction: CardQuoteRestore_subtitle_VideoTriggerBlock_triggerAction | null;
}
...
export interface CardQuoteRestore_title_VideoTriggerBlock {
   ...
   */
  triggerStart: number;
  triggerAction: CardQuoteRestore_title_VideoTriggerBlock_triggerAction | null;
}
...
export interface CardQuoteRestore_body_VideoTriggerBlock {
   ...
   */
  triggerStart: number;
  triggerAction: CardQuoteRestore_body_VideoTriggerBlock_triggerAction | null;
}
