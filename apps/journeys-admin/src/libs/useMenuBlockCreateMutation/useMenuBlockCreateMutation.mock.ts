...
import {
  MENU_BLOCK_X,
  MENU_BLOCK_Y
} from '../../components/Editor/EditorManager/Settings/CanvasDetails/JourneyAppearance/Menu/constants'
import {
  mockMenuButton1,
  mockMenuButton2,
  mockMenuButton3,
  ...
  mockMenuStep,
  mockMenuSubHeading
} from '../../components/Editor/EditorManager/Settings/CanvasDetails/JourneyAppearance/Menu/MenuActionButton/data'
