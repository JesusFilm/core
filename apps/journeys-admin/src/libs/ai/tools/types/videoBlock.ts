...
const videoBlockSourceEnum = z.enum([
  'cloudflare',
  'internal',
  'mux',
  'youTube'
...
const videoBlockObjectFitEnum = z.enum(['fill', 'fit', 'zoomed'])

export const videoBlockUpdateInputSchema = z.object({
  startAt: z
    .number()
    .nullable()
    .optional()
  ...
  objectFit: videoBlockObjectFitEnum
    .nullable()
    .optional()
    .describe('How the video should fit within its container')
})

export const videoBlockUpdateSchema = z.object({
  ...
  source: videoBlockSourceEnum.describe(
