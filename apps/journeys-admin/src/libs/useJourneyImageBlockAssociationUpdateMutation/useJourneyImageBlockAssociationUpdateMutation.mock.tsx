...
export const journeyImageBlockAssociationUpdateMock: MockLink.MockedResponse<JourneyImageBlockAssociationUpdate> =
  {
    request: {
    ...
    })) as MockLink.MockedResponse<JourneyImageBlockAssociationUpdate>['result']
  }
