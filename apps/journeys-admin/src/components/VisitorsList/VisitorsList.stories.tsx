...
export const Default: Story<ComponentProps<typeof VisitorsList>> = () => (
  <MockedProvider
    mocks={[
      {
        request: {
...
export const Loading: Story<ComponentProps<typeof VisitorsList>> = () => (
  <ApolloLoadingProvider>
    <VisitorsList />
  </ApolloLoadingProvider>
)

export default VisitorsListStory as Meta
