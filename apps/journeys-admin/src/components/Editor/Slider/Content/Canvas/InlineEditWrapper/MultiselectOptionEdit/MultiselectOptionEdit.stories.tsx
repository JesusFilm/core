...
const MultiselectOptionEditStory: Meta<typeof Canvas> = {
  ...
  component: Canvas,
  title: 'Journeys-Admin/Editor/Slider/Content/Canvas/MultiselectOptionEdit'
}

const option1: TreeBlock<MultiselectOptionFields> = {
...
export default MultiselectOptionEditStory
