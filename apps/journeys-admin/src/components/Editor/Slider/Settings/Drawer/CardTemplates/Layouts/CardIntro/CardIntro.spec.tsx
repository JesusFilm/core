...
describe('CardIntro', () => {
  ...
  const cardIntroCreateMock: MockLink.MockedResponse<
    CardIntroCreate,
    CardIntroCreateVariables
  > = {
    request: {
  ...
  const cardIntroDeleteMock: MockLink.MockedResponse<
    CardIntroDelete,
    CardIntroDeleteVariables
  > = {
    request: {
  ...
  const cardIntroRestoreMock: MockLink.MockedResponse<
    CardIntroRestore,
    CardIntroRestoreVariables
  > = {
    request: {
  ...
  it('should undo a card intro create', async () => {
    ...
    const result = vi.fn().mockReturnValue(cardIntroCreateMock.result)
    const result2 = vi.fn().mockReturnValue(cardIntroDeleteMock.result)
  ...
  it('should redo a card intro create', async () => {
    ...
    const result = vi.fn().mockReturnValue(cardIntroCreateMock.result)
    const result2 = vi.fn().mockReturnValue(cardIntroDeleteMock.result)
    const result3 = vi.fn().mockReturnValue(cardIntroRestoreMock.result)
