...
const HostList = dynamic(
  async () =>
    await import(
      /* webpackChunkName: "Editor/Tab/Attributes/blocks/JourneyAppearance/Host/HostList/HostList" */ './HostList'
...
const HostInfo = dynamic(
  async () =>
    await import(
      /* webpackChunkName: "Editor/Tab/Attributes/blocks/JourneyAppearance/Host/HostInfo/HostInfo" */ './HostInfo'
...
const HostForm = dynamic(
  async () =>
    await import(
      /* webpackChunkName: "Editor/Tab/Attributes/blocks/JourneyAppearance/Host/HostForm/HostForm" */ './HostForm'
