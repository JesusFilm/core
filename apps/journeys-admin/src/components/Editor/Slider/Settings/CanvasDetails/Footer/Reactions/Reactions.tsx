...
export type ReactionFields = keyof Pick<GetJourney_journey, 'showShareButton' | 'showLikeButton' | 'showDislikeButton'>
    ...
    add({ 
      ...
      optimisticResponse: {
        journeyUpdate: {
          ...
          showDislikeButton: input.showDislikeButton ??journey.showDislikeButton,
        }
      }
    })
      }
