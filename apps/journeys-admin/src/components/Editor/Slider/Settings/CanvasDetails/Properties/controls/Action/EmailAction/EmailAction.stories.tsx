...
const EmailActionStory: Meta<typeof EmailAction> = {
  ...
  title:
    'Journeys-Admin/Editor/Slider/Settings/CanvasDetails/Properties/controls/Action/EmailAction'
}

export const EmailActionComponent: StoryObj<typeof EmailAction> = {
  render: () => {
