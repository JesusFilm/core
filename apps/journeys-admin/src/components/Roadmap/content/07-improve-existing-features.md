...
as you swipe, and a swipe that navigates once it passes a threshold.
...
> **When someone opens the template library looking for something that fits
...
invest in, what to support, and what we can safely remove.

> **Do we instrument the builder first, so decisions about what to build come
> from real usage data — or do we decide from field feedback now and
> instrument later?**
