  ...
  return (
    <>
      ...
      <TabPanel
        ...
        unmountUntilVisible={activeTab !== journeyStatusTabs[0].tabIndex}
      >
        {activeList}
      </TabPanel>
      <TabPanel
        ...
        unmountUntilVisible={activeTab !== journeyStatusTabs[1].tabIndex}
      >
        {archivedList}
      </TabPanel>
      <TabPanel
        ...
        unmountUntilVisible={activeTab !== journeyStatusTabs[2].tabIndex}
      >
        {trashedList}
      </TabPanel>
    </>
