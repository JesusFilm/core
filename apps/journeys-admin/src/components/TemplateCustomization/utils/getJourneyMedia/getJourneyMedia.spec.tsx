...
describe('getJourneyMedia', () => {
  ...
  it('should extract customizable logo block when website is true', () => {
    const journey = {
      website: true,
      logoImageBlock: {
  ...
  it('should not extract customizable logo block when website is false', () => {
    const journey = {
      website: false,
      logoImageBlock: {
        __typename: 'ImageBlock',
  ...
  it('should not extract customizable logo block when website is null', () => {
    const journey = {
      website: null,
      logoImageBlock: {
        __typename: 'ImageBlock',
  ...
  it('should extract all three combinations of customizable blocks when website is true', () => {
    const journey = {
      website: true,
      logoImageBlock: {
        __typename: 'ImageBlock',
