  ...
  return (
    <>
      <NextSeo
        noindex
        nofollow
        titleTemplate="%s | Проект «Иисус»"
        defaultTitle="Пасха 2025: видео и материалы о Великом посте, Страстной неделе, Воскресении | Проект «Иисус»"
          ...
          images: [
            {
              ...
              width: 1400,
              height: 933,
              alt: 'Пасха - Проект «Иисус»',
              type: 'image/jpeg'
            }
          ],
          site_name: 'Проект «Иисус»'
        }}
        facebook={
