...
export type FormFields_action =
  | FormFields_action_NavigateAction
  | FormFields_action_NavigateToBlockAction
  | FormFields_action_NavigateToJourneyAction
  | FormFields_action_LinkAction
  | FormFields_action_EmailAction
