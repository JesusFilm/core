...
export interface GetVideoContentPart3_content_parents_title {
  __typename: "VideoTitle";
  value: string;
}

export interface GetVideoContentPart3_content_parents_variant {
  __typename: "VideoVariant";
  id: string;
  /**
   * slug is a permanent link to the video variant.
...
export interface GetVideoContentPart3_content_parents {
  __typename: "Video";
  id: string;
  label: VideoLabel;
  /**
  ...
  title: GetVideoContentPart3_content_parents_title[];
  variant: GetVideoContentPart3_content_parents_variant | null;
}
...
export interface GetVideoContentPart3_content {
   ...
   */
  childrenCount: number;
  parents: GetVideoContentPart3_content_parents[];
}
