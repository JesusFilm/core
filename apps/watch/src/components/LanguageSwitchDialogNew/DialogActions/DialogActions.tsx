...
export function DialogActions({
  ...
  const hasChanges =
    ...
    selectedAudioLanguage !== audioLanguageCookie ||
    selectedSubtitle !== subtitleLanguageCookie ||
    subtitlesOn.toString() !== subtitlesOnCookie
  ...
  return (
    <div className="flex gap-3">
      <button
        ...
        className="inline-flex items-center rounded-md bg-white px-6 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        aria-label={t('Cancel')}
        disabled={loading}
      >
        {t('Cancel')}
      ...
      <button
        ...
        className="inline-flex items-center rounded-md bg-gray-900 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
