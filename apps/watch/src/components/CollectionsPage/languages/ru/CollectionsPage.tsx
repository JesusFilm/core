    ...
    >
      <CollectionsPageContent>
        ...
        <CollectionIntroText
          ...
          subtitle="Что если Пасха глубже, чем вы думаете?"
          firstParagraph={{
            beforeHighlight:
              'За пределами яиц и кроликов лежит история о том, почему ',
            highlightedText: 'человечеству нужен спаситель.',
            afterHighlight:
              ' Евангелия честно передают муки Иисуса, отречение Петра и неверие учеников—сырые эмоции, которые отражают наши собственные борьбы.'
          }}
          secondParagraph="Это празднование триумфа говорит к нашим моментам сомнения и указывает на надежду за пределами нас самих.
Сомневаетесь? Ищете? Откройте для себя истинную силу Пасхи."
          easterDatesTitle="Когда празднуется Пасха в {year} году?"
          thirdParagraph="Исследуйте нашу коллекцию видео и интерактивных ресурсов, которые приглашают вас в подлинную историю—ту, что изменила историю и продолжает преображать жизни сегодня.
Потому что величайшее празднование в истории человечества — это гораздо больше, чем традиции—это сила воскресения"
