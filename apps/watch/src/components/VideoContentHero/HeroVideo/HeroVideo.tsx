...
export function HeroVideo({
  ...
  const shouldShowVisualOverlay = carouselItemAndCollapsed || singleVideoAndWasNotUnmuted;
  ...
  return (
    ...
    <div
      className={clsx(
        ...
        {
          'aspect-[var(--ratio-sm)] md:aspect-[var(--ratio-md-expanded)]': placement ==='singleVideo' || isPreview && collapsed,
          ...
          <video
            ...
            className={clsx(
              'vjs hero-hide-native-subtitles [&_.vjs-tech]:object-cover',
              {
                ...
                '[&_.vjs-tech]:object-contain': !collapsed || (placement ==='singleVideo' && !mute),
                'cursor-pointer': isPreview,
              }
            )}
            style={{
    ...
    {/* TODO: Reimplement VideoControls component */}
