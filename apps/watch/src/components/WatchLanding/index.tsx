...
const SharedVideoCard = ({ avatarSrc, name, message }: SharedVideoCardProps) => (
    <Box
        sx={{
            display: 'flex',
            alignItems: 'center',
...
const SectionHeader = ({ primaryText, secondaryText, disableTopSpacing }: SectionHeaderProps) => (
    <>
        <Typography
            variant="h4"
            sx={{
            ...
            >
                <Container maxWidth="xxl" sx={{ paddingY: '4rem' }}>
                    ...
                    >
                        ...
                        >
                            <Typography variant="overline" sx={{ letterSpacing: 2, opacity: 0.5 }}>Video Overline</Typography>
                  ...
                  `,
                    ...
                    <Typography variant="h4" sx={{ mt: 16, mb: 0, color: 'text.primary' }}>
                        Emotional wounds
                    </Typography>
                    <Typography variant="subtitle1" sx={{ mt: 0, mb: 6, opacity: 0.5, color: 'text.primary' }}>
                    ...
                    >
                        <Box
                            ...
                            playsInline
                        >
                            <source src="https://cdn-std.droplr.net/files/acc_760170/dzSp48" type="video/mp4" />
                            Your browser does not support the video tag.
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            <Typography variant="overline" sx={{ letterSpacing: 2, opacity: 0.5 }}>Trusting God with Your Pain:</Typography>
                            <Typography variant="h4" mb={2}>Healing Emotional Scars Through Faith</Typography>
                            <Typography variant="body1">Discover how faith and spirituality can provide comfort and strength during challenging times of depression.</Typography>
                        </Box>
                    </Box>
                    ...
                    >
                        <Box
                            ...
                            playsInline
                        >
                            <source src="https://cdn-std.droplr.net/files/acc_760170/BIVSDq" type="video/mp4" />
                            Your browser does not support the video tag.
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            <Typography variant="overline" sx={{ letterSpacing: 2, opacity: 0.5 }}>Why God is not hearing you?</Typography>
                            <Typography variant="h4" sx={{
                                lineHeight: 1.2,
                                fontSize: { xs: '27px', sm: 'inherit' } // Adjust font size for mobile
                            }} mb={2}> <span style={{ marginLeft: '-0.5em' }}>&ldquo;</span>Let this cup <em>of sorrow</em> pass from me&hellip;&rdquo;&mdash; Jesus cried</Typography>
                    ...
                    <Box sx={{
                        ...
                        backgroundImage: 'url(https://cdn-std.droplr.net/files/acc_760170/kvJNRP)',
                        backgroundColor: 'rgba(255,255,255,0.05)',
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        '&::before': {
                        ...
                        >
                            <Typography variant="overline" sx={{ letterSpacing: 2, color: '#fff', opacity: 0.75 }}>Video Series</Typography>
                            <Typography variant="h2" sx={{ mb: 3, color: '#fff', fontWeight: 800 }}>
                                NUA: Fresh Perspective
                            </Typography>
                            <Typography variant="subtitle1" sx={{ mt: 0, mb: 0, opacity: 0.8, color: '#fff' }}>
                                Fresh Perspective Series — 15-minute episodes tackling faith, science, suffering, and Jesus’ story. Start your journey with NUA!
                            </Typography>
                        </Box>
