...
interface NameProps {
  setName: SlideContext['setName']
  goTo: SlideContext['goTo']
  t: SlideContext['t']
}

export function Name({ setName, goTo, t }: NameProps) {
...
// Export as a slide definition
export const nameSlide = {
  id: 'name',
  render: (ctx: SlideContext) => <Name {...ctx} />
}
