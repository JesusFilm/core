...
export const EasterDates = (): ReactElement => {
  ...
  return (
    <div
      className="relative overflow-hidden bg-gradient-to-tr from-blue-400 via-amber-500 to-red-600 bg-blend-multiply animate-mesh-gradient hover:animate-mesh-gradient-fast rounded-lg shadow-lg group"
