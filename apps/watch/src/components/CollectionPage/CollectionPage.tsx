...
export function CollectionPage(): ReactElement {
  ...
  return (
    <VideoMuteProvider initialMuted={true}>
      <div
        className="bg-stone-800 text-white min-h-screen font-sans"
        data-testid="CollectionPage"
      >
        <div className="max-w-[1800px] mx-auto shadow-2xl shadow-stone-950/70">
          <PageWrapper
            hero={<ContainerHero />}
          ...
          >
            ...
            ></div>
            {/* Above block with blur filter compensated with negative margin bellow.
              Test desktop Safari if making any changes to the blured block. */}
            <div
              className="mt-[-100vh] mx-auto z-2 relative border-t border-stone-500/30"
              data-testid="CollectionContent"
            >
              <div className="pt-7">
                <Swiper
                  slidesPerView={'auto'}
                  ...
                  draggable
                >
                  <SwiperSlide className="max-w-[200px] pl-6 xl:pl-12  2xl:pl-20">
              ...
              <div className="flex flex-col py-7 md:py-17">
                <div className="block xl:flex padded pb-16">
                  <div className="dates-block xl:w-2/5 2xl:pr-0 order-last pb-12 xl:pb-0">
                    <EasterDates />
                  </div>
                  <div className="into-text xl:w-3/5 space-y-6 xl:pr-20">
                    ...
                    <p className="text-xl xl:text-2xl">
                      ...
                      about the emotions Jesus experienced&mdash;His deep
                      anguish, one of His closest friends denying even to know
                      Him, and other disciples&mdash;disbelief in His
                      resurrection.
                    </p>
                    <p className="text-xl xl:text-2xl ">
                      If you have doubts or want to rediscover the meaning of
                      Easter explore this collection of videos and interactive
                      resources.
                    </p>
                  </div>
                </div>
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                              God remains in control even when circumstances
                              feel out of control
                            </li>
                            <li>
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              According to Scripture, He descended to the realm
                              of the dead
                            </li>
                            <li>
                ...
                <div className="relative bg-linear-to-tr from-blue-950/10  via-purple-950/10 to-[#91214A]/90 py-16">
                  ...
                  <div className="">
                    <Swiper
                      ...
                      className="w-full"
                    >
                      <SwiperSlide className="!w-[296px] pl-6 py-8 relative 2xl:pl-20 xl:pl-12">
                        <a
                  ...
                  <div className="padded space-y-6">
                    <p className="text-lg xl:text-xl mt-4 leading-relaxed text-stone-200/80">
                      ...
                      is to introduce introduce people to the Bible through
                      films and videos that faithfully bring the Gospels to
                      life. By visually telling the story of Jesus and God's
                      love for humanity, we make Scripture more accessible,
                  ...
                  questions={[
                      ...
                      answer: (
                        <>
                          <p>
                            ...
                            innocence and divinity, humbly asking to be
                            remembered in His kingdom. Jesus' response shows:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              Jesus came to save the lost, including criminals
                              and outcasts
                            </li>
                            <li>
                              Grace is freely given to those who sincerely seek
                              it
                            </li>
                          </ul>
                        </>
                    ...
                    },
                    {
                      ...
                      answer: (
                        <>
                          <p>
                            Jesus willingly accepted death because it was part
                            of God's plan for redemption. His sacrifice was
                            necessary to fulfill prophecy and bring salvation.
                            Key reasons include:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                              His death fulfilled Old Testament prophecies
                              (Isaiah 53)
                            </li>
                            <li>
                              He took on the punishment for humanity's sins
                            </li>
                            <li>
                              By not saving Himself, He demonstrated His
                              ultimate love and obedience to God
                            </li>
                            <li>
                    ...
                    },
                    {
                      ...
                      answer: (
                        <>
                          <p>
                            Being in paradise with Jesus means eternal life in
                            the presence of God. The thief on the cross was
                            assured of his place with Jesus in heaven because of
                            his faith. Important aspects of this promise
                            include:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                            ...
                            <li>
                              Jesus' words affirm the reality of life beyond
                              this world
                            </li>
                          </ul>
                        </>
                      ...
                      answer: (
                        <>
                          <p>
                            ...
                            redemption. Like many of us, she carried a past
                            filled with struggles, but Jesus freed her and gave
                            her a new purpose. Her story teaches us:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                    ...
                    },
                    {
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                              He welcomed sinners and outcasts, disrupting
                              social norms
                            </li>
                            <li>
                ...
                <div className="relative bg-linear-to-tr from-violet-950/10  via-indigo-500/10 to-cyan-300/50 py-16">
                  ...
                  <div className="padded space-y-6 pt-6 pb-10">
                    <p className="leading-relaxed text-orange-200/80">
                  ...
                  <div className="pt-8">
                    <Swiper
                      ...
                      spaceBetween={20}
                    >
                      <SwiperSlide className="max-w-[200px] pl-6 2xl:pl-20 xl:pl-12">
                  ...
                  questions={[
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              His death satisfied God's justice while showing
                              His mercy
                            </li>
                            <li>
                    ...
                    },
                    {
                      ...
                      answer: (
                        <>
                          <p>
                            Jesus' death and resurrection opened the way for us
                            to be reconciled with God. Through Him, we can:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                  ...
                  questions={[
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              His disciples, once afraid, boldly preached and
                              died for this truth
                            </li>
                          </ul>
                        </>
                    ...
                    },
                    {
                      ...
                      answer: (
                        <>
                          <p>
                            Jesus' resurrection calls for a personal response.
                            We can:
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              Share the good news of His resurrection with
                              others
                            </li>
                            <li>
                              Live with hope, knowing that He will return one
                              day
                            </li>
                          </ul>
                        </>
                  ...
                  questions={[
                    {
                      ...
                      answer: (
                        <>
                          <p>
                            The Bible teaches that everything began with God,
                            the Creator of the universe. He spoke everything
                            into existence with purpose and design. Humanity was
                            created in His image to live in harmony with Him,
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              Humans were designed to have a personal
                      ...
                      answer: (
                        <>
                          <p>
                            ...
                            humanity chose to rebel against God. This
                            disobedience broke the original perfection,
                            introducing death, pain, and separation from God.
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
                              Sin brought suffering, brokenness, and death
                            </li>
                      ...
                      answer: (
                        <>
                          ...
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            ...
                            <li>
                              His resurrection proves His power over death
                            </li>
                            <li>
                      ...
                      answer: (
                        <>
                          <p>
                            ...
                            Jesus will live forever with Him in a perfect,
                            renewed world. Sin, suffering, and death will be no
                            more.
                          </p>
                          <ul className="list-disc pl-6 mt-2 space-y-2">
                            <li>
