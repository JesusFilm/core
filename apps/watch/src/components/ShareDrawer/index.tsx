...
const shareCategories = [
  ...
  { id: 'mid-aged', label: 'Mid-aged', selected: true },
  { id: 'male', label: 'Male', selected: true },
...
export function ShareDrawer({
  ...
  const handleCopyToClipboard = (text: string, type: 'link' | 'message') => {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: <PersonIcon />,
      description:
        "What you share only works when it's relevant. Customize the content and recommendations for your audience."
    },
    {
      label: 'Link & Message',
      icon: <LinkIcon />,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: 1, overflow: 'auto', position: 'relative', pl: 6 }}>
                      ...
                      <Box sx={{ position: 'relative' }}>
                        ...
                        >
                          <Typography
                            variant="h3"
                            color="text.primary"
                            sx={{ fontSize: '1.7rem', px: 4, mr: 2 }}
                          >
                            👍&nbsp;👎
                          </Typography>
                          <Stack direction="column" spacing={0.5}>
                            <Typography variant="body2" color="text.primary">
                              These categories help personalize recommended
                              videos that will follow after the shared one.
                            </Typography>
                          </Stack>
                        </Box>
                        ...
                        <Box sx={{ flex: 1, overflow: 'auto', mb: 3 }}>
                          ...
                          >
                            ...
                            <Button
                              ...
                              color="primary"
                              size="small"
                              sx={{ fontSize: '13px', fontWeight: 400, p: 2 }}
                            >
                              See All
                            </Button>
                          </Box>
                        ...
                        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                          {categories.map((category) => (
                            <Chip
                              ...
                              variant={
                                category.selected ? 'filled' : 'outlined'
                              }
