...
const jesusFeatureFilm: VideoFields = {
  __typename: 'Video',
  id: '1_jf-0-0',
  ...
  children: [
    ...
    },
    {
      ...
      id: '1_jf6104-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Baptism of Jesus by John' }],
      image:
    ...
    },
    {
      ...
      id: '1_jf6108-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Miraculous Catch of Fish' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Sinful Woman Forgiven' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '1_jf6120-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Healing of the Demoniac' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Healing of Bartimaeus' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '1_jf6135-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: "Jesus's Triumphal Entry" }],
      image:
    ...
    },
    {
      ...
      id: '1_jf6150-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Jesus Carries His Cross' }],
      image:
...
const lifeOfJesus: VideoFields = {
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'life-of-jesus-gospel-of-john/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
  ...
  children: [
    {
      ...
      id: '2_GOJ4901-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: "God's Word Becomes Flesh" }],
      image:
    ...
    },
    {
      ...
      id: '2_GOJ4903-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Jesus Gathers Disciples' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: "Official's Son Healed" }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Mary and Martha Mourn' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '2_GOJ4939-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Grief will Turn to Joy!' }],
      image:
    ...
    },
    {
      ...
      id: '2_GOJ4944-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'The Crucifixion of Jesus' }],
      image:
    ...
    },
    {
      ...
      snippet: [
        {
          __typename: 'Translation',
          value: 'Jesus appears to his disciples again and performs a miracle.'
        }
      ],
...
const jesusCalmsTheStorm: VideoFields = {
  __typename: 'Video',
  id: '1_jf6119-0-0',
  label: VideoLabel.segment,
  image:
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'jesus-calms-the-storm/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const womanWithBlood: VideoFields = {
  __typename: 'Video',
  id: '1_wl604423-0-0',
  label: VideoLabel.segment,
  image:
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'the-woman-with-the-issue-of-blood/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const magdalena: VideoFields = {
  ...
  children: [
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Announcement to Mary' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'The Woman at the Well' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
...
const reflectionsOfHope: VideoFields = {
  __typename: 'Video',
  id: '1_wl7-0-0',
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'reflections-of-hope/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const jesusDiedForMe: VideoFields = {
  __typename: 'Video',
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'day-6-jesus-died-for-me/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
  ...
  children: [
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Introduction of Luke' }],
      snippet: [
        {
          __typename: 'Translation',
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Ananias and Sapphira' }],
      snippet: [{ __typename: 'Translation', value: 'A couple lies to God.' }],
    ...
    },
    {
      ...
      id: '2_Acts7314-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'The Apostles Persecuted' }],
      image:
    ...
    },
    {
      ...
      snippet: [
        {
          __typename: 'Translation',
          value: 'Stephen prayed forgiveness on those who stoned him to death.'
        }
      ],
    ...
    },
    {
      ...
      id: '2_Acts7322-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Philip and the Ethiopian' }],
      image:
    ...
    },
    {
      ...
      id: '2_Acts7326-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Cornelius Sees an Angel' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'The Church in Antioch' }],
      snippet: [
    ...
    },
    {
      ...
      id: '2_Acts7339-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'The Council at Jerusalem' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Riots in Thessalonica' }],
      snippet: [
        {
          __typename: 'Translation',
    ...
    },
    {
      ...
      id: '2_Acts7359-0-0',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'Paul Speaks to the Crowd' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'The Plot to Kill Paul' }],
      snippet: [
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'Paul Ashore on Malta' }],
      snippet: [
...
const weddingInCana: VideoFields = {
  __typename: 'Video',
  id: '2_GOJ4904-0-0',
  label: VideoLabel.segment,
  image:
...
const peterEscape: VideoFields = {
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'peter-miraculous-escape-from-prison/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const whoIsJesus: VideoFields = {
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: '8-days-with-jesus-who-is-jesus/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const chosenWitness: VideoFields = {
  __typename: 'Video',
  id: '2_ChosenWitness',
  label: VideoLabel.shortFilm,
  image:
...
const gospelOfLuke: VideoFields = {
  __typename: 'Video',
  id: 'GOLukeCollection',
  label: VideoLabel.collection,
  image:
    'https://d1wl257kev7hsz.cloudfront.net/cinematics/GOLukeCollection.mobileCinematicHigh.jpg',
  imageAlt: [{ __typename: 'Translation', value: 'LUMO - The Gospel of Luke' }],
  snippet: [
    {
      __typename: 'Translation',
      value:
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'lumo-the-gospel-of-luke/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
  ...
  children: [
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'LUMO - Luke 1:57-2:40' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'LUMO - Luke 2:41-3:38' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'LUMO - Luke 8:40-9:17' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '6_GOLuke2616',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'LUMO - Luke 15:11-16:31' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'LUMO - Luke 17:1-18:8' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '6_GOLuke2620',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'LUMO - Luke 19:45-20:47' }],
      image:
    ...
    },
    {
      ...
      id: '6_GOLuke2622',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'LUMO - Luke 21:37-22:38' }],
      image:
    ...
    },
    {
      ...
      id: '6_GOLuke2623',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'LUMO - Luke 22:39-23:25' }],
      image:
    ...
    },
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'LUMO - Luke 23:26-56' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
    ...
    },
    {
      ...
      id: '6_GOLuke2626',
      label: VideoLabel.segment,
      title: [{ __typename: 'Translation', value: 'LUMO - Luke End Credits' }],
      image:
...
const jesusAndZacchaeus: VideoFields = {
  __typename: 'Video',
  id: '1_cl1309-0-0',
  label: VideoLabel.episode,
  image:
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'storyclubs-jesus-and-zacchaeus/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const birthOfJesus: VideoFields = {
  __typename: 'Video',
  id: '1_jf6102-0-0',
  label: VideoLabel.segment,
  image:
...
const fallingPlates: VideoFields = {
  __typename: 'Video',
...
const paulAndSilas: VideoFields = {
  __typename: 'Video',
  id: '2_Acts7345-0-0',
  label: VideoLabel.segment,
  image:
    'https://d1wl257kev7hsz.cloudfront.net/cinematics/2_Acts7345-0-0.mobileCinematicHigh.jpg',
  imageAlt: [{ __typename: 'Translation', value: 'Paul and Silas in Prison' }],
  snippet: [
    {
      __typename: 'Translation',
      value: 'Paul and Silas beaten and imprisoned for casting out a demon.'
  ...
  variantLanguagesWithSlug: [
    {
      __typename: 'LanguageWithSlug',
      slug: 'paul-and-silas-in-prison/french',
      language: {
        id: '496',
        __typename: 'Language',
        name: [
...
const myLastDay: VideoFields = {
  ...
  studyQuestions: [
    ...
    {
      __typename: 'Translation',
      value: 'What do you think about the idea of being with Jesus in paradise?'
    }
  ],
  ...
  children: [
    {
      ...
      imageAlt: [{ __typename: 'Translation', value: 'My Last Day - Trailer' }],
      snippet: [
        {
          __typename: 'Translation',
          value:
...
export const videos: VideoFields[] = [
  jesusFeatureFilm,
  lifeOfJesus,
  jesusCalmsTheStorm,
  womanWithBlood,
