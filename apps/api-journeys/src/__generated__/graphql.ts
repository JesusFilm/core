...
export type GetLanguageQuery = { __typename?: 'Query', languages: Array<{ __typename?: 'Language', id: string, name: Array<{ __typename?: 'Translation', value: string, primary: boolean }> }> };
