...
const result = journeySimpleSchema.safeParse({})
...
const processSteps = [
  ...
  },
  {
    title: 'Publish & Share',
    description:
      'Send your creations straight to social or download them anywhere.'
  }
]
          ...
          <section className="relative overflow-hidden py-24">
            ...
            <div className="container mx-auto flex flex-col items-center gap-10 px-4 text-center">
              ...
              <p className="max-w-2xl text-lg text-stone-600 md:text-xl">
                Our AI-powered studio helps believers create content and
                conversations that point hearts toward Jesus by incorporating
                relevant bible verses, stories, and images.
              </p>
              <p className="max-w-2xl text-base text-stone-500">
                Upload a photo, paste a verse, or describe a moment—and watch it
                grow into visuals, messages, and videos filled with grace and
                salt.
              </p>
              ...
              <p className="max-w-2xl text-sm text-stone-500">
                Upload a photo, paste a verse, or describe a moment—and watch it
                grow into visuals, messages, and videos filled with grace and
                salt. From social posts to live conversation guides, this tool
                transforms inspiration into shareable impact. What begins as a
                simple idea becomes a story that invites reflection, connection,
                and hope.
              </p>
            </div>
          </section>
            ...
            <div className="container mx-auto grid items-center gap-16 px-4 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="space-y-6">
                ...
                <p className="text-lg text-stone-600">
                  Guided by Scripture. Built to understand people. Whether
                  you’re comforting a friend, answering hard questions, or
                  speaking hope online, our AI helps you express truth with
                  gentleness. It suggests tone, phrasing, and verses that keep
                  your words full of grace and salt.
                </p>
                <div className="rounded-3xl bg-white/80 p-6 shadow-lg shadow-sky-100">
                  <div className="space-y-4 text-left text-sm text-stone-600">
                    <div className="flex items-start gap-3">
                      <MessageCircle
                        className="mt-1 h-5 w-5 text-sky-500"
                        aria-hidden="true"
                      />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p>
                          “I’m sorry you’re going through that. Can I share
                    ...
                    <div className="flex items-start gap-3 rounded-2xl bg-stone-900/90 p-4 text-stone-100">
                      ...
                      <div>
                        ...
                        <p>
                          Try suggesting John 14:6 or a short story about
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-stone-900 via-stone-800 to-stone-700 p-8 text-stone-100 shadow-2xl">
                ...
                <p className="mt-3 text-sm text-stone-200/80">
                  The Communication view watches for emotional cues and suggests
                  scripture, thoughtful questions, and gentle language—all in
                  real time. Every hint is designed to help you carry grace and
                ...
                <div className="mt-8 grid gap-4 text-sm">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="text-stone-200/80">
                      Highlights what your friend might be feeling so you can
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="text-stone-200/80">
                      Offers phrase ideas and scripture prompts tuned for the
                      moment.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="text-stone-200/80">
                      Gives next-step guidance for keeping the dialogue open and
                      hopeful.
                    </p>
                  </div>
                </div>
          ...
          <section className="relative overflow-hidden py-24">
            ...
            <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-6">
                ...
                <h3 className="text-balance text-3xl font-semibold text-stone-900 md:text-4xl">
                  Transform your message into ready-to-share designs for every
                  platform.
                </h3>
                <p className="text-lg text-stone-600">
                  Whether it starts with a verse, a quote, or a thought from
                  your journal, our tool shapes it into platform-ready visuals,
                  stories, or posts. One seed of truth, countless ways to share
                  it. Download in PNG, JPG, or JSON formats.
                </p>
              ...
              <div className="space-y-6">
                <div className="rounded-3xl bg-white/70 p-8 shadow-xl shadow-indigo-100">
                  <h4 className="text-lg font-semibold text-stone-900">
                    One click, infinite ways to inspire.
                  </h4>
                  <p className="mt-4 text-sm text-stone-600">
                    Choose from elegant, story-based templates made for
                    outreach, devotionals, and community engagement. Generate
                    scroll-stopping designs with motion and graphics that feel
                    timeless. Zero editing, zero delay—just truth told
                    beautifully.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-3 text-sm">
                    {visualLabels.map((label) => (
                      <span
                        key={label}
                        className="rounded-full bg-stone-900/90 px-4 py-1 text-white"
                      >
                        {label}
                      </span>
                    ))}
          ...
          <section className="py-24">
            <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="order-2 space-y-6 lg:order-1">
                ...
                <p className="text-lg text-stone-600">
                  Our AI turns any verse or passage into a dynamic short video,
                  complete with motion, music, and visual storytelling. Every
                  verse becomes an experience—clickable, relatable, and ready to
                  inspire deeper exploration of God’s Word.
                </p>
                <p className="text-sm text-stone-500">
                  Each video verse includes interactive layers so people can
                  explore related stories or teachings with a single tap. It’s
                  visual beauty and gospel accessibility in one flow.
                </p>
                <Button size="lg" asChild>
                ...
                <div className="mt-8 grid gap-4">
                  <div className="rounded-2xl border border-white/20 bg-white/10 p-4">
                    ...
                    <p className="text-xs text-stone-100/70">
                      Sunrise over a city, hands lifted in worship, families
                      embracing—each clip curated to echo the verse’s hope.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/20 bg-white/10 p-4">
                    <p className="text-sm font-semibold">Interactive Layers</p>
                    <p className="text-xs text-stone-100/70">
                      Tap to explore related teachings, testimonies, or
                      conversation starters linked to the verse.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="container mx-auto flex flex-col gap-12 px-4">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-stone-600">
                  From one idea to a full campaign of grace-filled stories—our
                  process is clear, fast, and beautifully human.
                </p>
              </div>
                  ...
                  >
                    ...
                    {index === 0 && (
                      <p className="mt-6 text-xs text-stone-500">
                        Input: “John 3:16” → Output: Video Verse, Instagram
                        Story, Quote Card, Conversation Guide
                      </p>
                    )}
                  </div>
                ))}
          ...
          <section className="py-24">
            <div className="container mx-auto grid gap-16 px-4 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-6">
                ...
                <p className="text-lg text-stone-600">
                  Bring ideas from anywhere—your camera roll, notes app,
                  favorite verses, or social feeds—and watch them become
                  messages of hope.
                </p>
                <p className="text-sm text-stone-500">
                  Snap a photo, paste a quote, record a thought, or drop in
                  anything that moves you. Our AI reads the tone, extracts the
                  heart, and turns it into designs, reels, and stories that
                  shine with grace and truth. You don’t need to create from
                  scratch—just offer the spark.
                </p>
                <div className="flex flex-wrap gap-3">
                  {inputTypes.map((type) => (
                    <span
                      key={type}
                      className="rounded-full bg-white/70 px-4 py-1 text-sm font-medium text-stone-600 shadow-sm"
                    >
                      {type}
                    </span>
                  ))}
                ...
                <div className="grid gap-6 text-sm text-stone-700">
                  <div className="rounded-2xl border border-white/70 bg-white/80 p-6 shadow-sm">
                    ...
                    <p className="mt-2 text-lg font-semibold">
                      “How do I encourage my Bible study this week?”
                    </p>
                  </div>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-amber-200 bg-white/80 p-4">
                      ...
                      <ul className="mt-2 space-y-2 text-xs text-stone-600">
                        ...
                        <li>
                          • Instagram carousel with verses on encouragement
                        </li>
