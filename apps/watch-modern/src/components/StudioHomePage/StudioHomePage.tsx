    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container flex flex-col gap-4 py-10 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
              A focused creative space for crafting immersive gospel-centered
              experiences.
            </p>
          </div>
          {hero ?? (
      ...
      <main className="container flex flex-col gap-16 py-16">
        <section className="grid gap-8 rounded-3xl border border-border/40 bg-card/60 p-10 shadow-2xl">
          ...
          <p className="text-base leading-relaxed text-muted-foreground">
            Studio is where stories take shape. While we prepare the full
            experience, explore a curated selection of resources,
            behind-the-scenes updates, and tools that will empower your ministry
          ...
          <ul className="grid gap-6 text-muted-foreground md:grid-cols-3">
            <li className="rounded-2xl border border-border/30 bg-background/40 p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed">
                Immersive narratives tailored for different cultures and
                ministry contexts.
              </p>
            </li>
            <li className="rounded-2xl border border-border/30 bg-background/40 p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed">
                Downloadable toolkits and visual assets to help you share the
                gospel.
              </p>
            </li>
            <li className="rounded-2xl border border-border/30 bg-background/40 p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed">
                Connect with filmmakers, ministry leaders, and storytellers from
                around the world.
              </p>
            </li>
          </ul>
      ...
      <footer className="border-t border-border/40 bg-background/80 py-10">
        <div className="container text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} Jesus Film Project. All rights
          reserved.
        </div>
      </footer>
    </div>
