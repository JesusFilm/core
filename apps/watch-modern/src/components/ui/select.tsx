  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        position === "popper" &&
          "translate-y-1 data-[side=bottom]:animate-in data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:-translate-y-1 data-[side=top]:animate-in",
        className
      )}
      position={position}
      {...props}
