...
export namespace JourneyModule {
  ...
  export type JourneyCreateInput = Pick<
    Types.JourneyCreateInput,
    DefinedInputFields['JourneyCreateInput']
  >
  export type JourneyUpdateInput = Pick<
    Types.JourneyUpdateInput,
    DefinedInputFields['JourneyUpdateInput']
  >
  export type Mutation = Pick<Types.Mutation, DefinedFields['Mutation']>
  export type NavigateToJourneyAction = Types.NavigateToJourneyAction

  export type JourneyResolvers = Pick<
    Types.JourneyResolvers,
    DefinedFields['Journey'] | '__isTypeOf'
  >
