...
export namespace ButtonModule {
  ...
  export type ButtonBlock = Pick<
    Types.ButtonBlock,
    DefinedFields['ButtonBlock']
  >
  export type Icon = Types.Icon
  export type Action = Types.Action
  export type Block = Types.Block

  export type ButtonBlockResolvers = Pick<
    Types.ButtonBlockResolvers,
    DefinedFields['ButtonBlock'] | '__isTypeOf'
  >
