...
export namespace ImageModule {
  ...
  export type ImageBlockCreateInput = Pick<
    Types.ImageBlockCreateInput,
    DefinedInputFields['ImageBlockCreateInput']
  >
  ...
  export type ImageBlockResolvers = Pick<
    Types.ImageBlockResolvers,
    DefinedFields['ImageBlock'] | '__isTypeOf'
  >
