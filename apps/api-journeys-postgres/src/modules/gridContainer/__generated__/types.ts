...
export namespace GridContainerModule {
  ...
  export type GridContainerBlock = Pick<
    Types.GridContainerBlock,
    DefinedFields['GridContainerBlock']
  >
  export type Block = Types.Block

  export type GridContainerBlockResolvers = Pick<
    Types.GridContainerBlockResolvers,
    DefinedFields['GridContainerBlock'] | '__isTypeOf'
  >
