/**
 * Shared visual tokens for the public template-gallery page.
 *
 * `GALLERY_ACCENT` is the journeys-admin brand red (journeysAdmin palette
 * primary.main), hard-coded so the public page keeps the admin accent
 * regardless of the active MUI theme.
 */
