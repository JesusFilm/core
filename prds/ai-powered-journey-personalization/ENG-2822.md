...
3. **Simplified JSON Structure**
   ...
   - **Journey Object**: Contains title, description, theme, and global settings
   - **Steps Array**: Sequential content flow with content items
   - **Content Types**: Support heading, text, button, image, background-image
   - **Navigation Flow**: NextStep linking between steps
  ...
  "steps": [
    {
      ...
      "content": [
        ...
        { "type": "text", "text": "Journey content..." },
        { "type": "button", "text": "Continue", "action": "next" },
        { "type": "background-image", "src": "https://...", "alt": "Background" }
      ],
      "nextStep": "step-2",
...
- **heading**: Text with level (1-6), where 1 is largest
- **text**: Plain text content for body copy
- **button**: Interactive element with text and action
- **image**: Media content with URL and alt text
- **background-image**: Step background with URL and alt text
